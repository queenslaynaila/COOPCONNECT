...
export default function Internshipssavedcard({internship}) {
  ...
  return (
    ...
    <div class="card-body">
      ...
      <div className='d-flex flex-row' style={{gap:"10px"}}>
            <div><span className='fw-bold'>OPENNINGS AVAILABLE:</span>&nbsp;&nbsp;
            {internship.internship.positionsvailable}</div>
      ...
      <div  className='d-flex flex-row' style={{gap:"10px"}}>
      <p><span className='fw-bold'>Maximum Salary: </span>&nbsp;&nbsp;{internship.internship.salary}</p>

      </div>

      <div className='mt-1'>

        <p>{internship.internship.overallsummarry}</p>
      </div>
    </div>
