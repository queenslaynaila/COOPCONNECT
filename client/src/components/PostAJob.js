		  ...
		  <div class="card-body">
            <form>
			  <div className='row'>
					<div className='col'>
				     	<div class="mb-3">
							...
							<input type="text" id="organizationname" class="form-control"></input>
						</div>
					</div>
					<div className='col'>
					   <div class="mb-3">
							<label htmlFor="experience" class="form-label fs-5">Experience in Years:</label>
							<input type="text" id="experience" class="form-control"></input>
                       </div>
					</div>
			  </div>
			  ...
			  <div className='row'>
				...
				<input type="text" id="position" class="form-control"></input>
                  </div>
				</div>
				<div className='col'>
				  <div class="mb-3">
			    <label htmlFor="positionavailable" class="form-label fs-5">Positions Available:</label>
				<input type="text" id="positionavailable" class="form-control"></input>
                  </div>
				</div>
			  </div>
			 ...
			 <div className='row'>
				<div className='col'>
				   <div class="mb-3">
				     ...
				     <input type="text" id="minsalary" class="form-control"></input>
                   </div>
				</div>
				<div className='col'>
				  <div class="mb-3">
			 ...
			 <div className='row'>
				...
				<option selected >Minimum Educational Qualifications</option>
			 ...
			 <div className='row'>
			   <div className='col'>
					<div class="mb-3">
						...
						<input type="text" id="joblocation" class="form-control"></input>
					</div>
				</div>
				<div className='col'>
					<div class="mb-3">
						<label htmlFor="keyskills" class="form-label fs-5">Key Skills:</label>
						<input type="text" id="keyskills" class="form-control"></input>
					</div>
				</div>
			  </div>
			  <div class="form-group">
				<label for="exampleFormControlTextarea1" className='fs-5'>Job Responsibilities</label>
				<textarea class="form-control" id="exampleFormControlTextarea1" placeholder='Enter job responsibilities,searate them with commas' rows="3"></textarea>
             </div>
			</form>
          </div>
